...
buffoni = Place.create!(event: e1, google_id: "a12345", name: "Buffoni", address: "12 Rue Fancul", rating: "3.9")
sweet = Place.create!(event: e1, google_id: "b1234zret", name: "Sweet Bastard", address: "20 Allée Shit", rating: "4.5")
connard = Place.create!(event: e1, google_id: "c1234retr", name: "Chez Connard", address: "48 Impasse Naze", rating: "4.1")
...
e3 = Event.create!(name: 'Afterwork', start_at: date, kind: 0, user: u2)

italian = Place.create!(event: e3, google_id: "a1234eztr", name: "Buffoni", address: "12 Rue Fancul", rating: "3.9")
english = Place.create!(event: e3, google_id: "b123zef4", name: "Sweet Bastard", address: "2 Cours d'Alsace-et-Lorraine, 33000 Bordeaux
", rating: "4.5")
french = Place.create!(event: e3, google_id: "c123zef4", name: "Chez Connard", address: "48 Impasse Naze", rating: "4.1")
